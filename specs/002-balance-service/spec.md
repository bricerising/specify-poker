...
**Feature Branch**: `002-balance-service`
**Created**: 2026-01-11
**Status**: In Development
**Input**: Extract user and table pot balance management from the poker service into
a separate microservice with persistent account balances, transaction ledger, and
real-money ready design.
