...
import { Card } from "../../src/domain/types";
  ...
  describe("evaluateWinners", () => {
    it("should determine single winner", () => {
      ...
      const players: Record<number, Card[]> = {
        0: [{ rank: "A", suit: "hearts" }, { rank: "K", suit: "hearts" }], // Ace high
        1: [{ rank: "Q", suit: "hearts" }, { rank: "J", suit: "hearts" }], // Queen high
      };
    ...
    it("should handle split pots", () => {
      ...
      const players: Record<number, Card[]> = {
        ...
        1: [{ rank: "4", suit: "hearts" }, { rank: "5", suit: "hearts" }],
      };
    ...
    it("should compare same hand categories correctly", () => {
      ...
      const players: Record<number, Card[]> = {
        0: [{ rank: "A", suit: "hearts" }, { rank: "A", suit: "diamonds" }], // Pair of Aces
        1: [{ rank: "K", suit: "hearts" }, { rank: "K", suit: "diamonds" }], // Pair of Kings
      };
