...
describe("nicknameService consumer behavior", () => {
  ...
  it("rejects invalid nicknames", () => {
    expect(() => nicknameService.validateNickname("")).toThrow("Nickname must be between 1 and 30 characters");
    expect(() => nicknameService.validateNickname("$$$")).toThrow("Nickname contains invalid characters");
  });
